# Anticipos
Plugin gratuito para FacturaScripts y la gestión de cobros y pagos a cuenta de proyectos, clientes, proveedores y sus documentos.
- https://facturascripts.com/plugins/anticipos

## Issues / Contacto del plugin Anticipos
