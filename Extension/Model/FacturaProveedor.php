...
/**
 * Description of FacturaProveedor
 *
...
class FacturaProveedor
{
    public function saveUpdate(): Closure
    {
        return function () {
            ...
            $estado->loadFromCode($this->idfactura);
            ...
            $where1 = [new DataBaseWhere('idfactura', $this->idfactura)];
            ...
            $where2 = [
                new DataBaseWhere('model1', 'FacturaProveedor'),
